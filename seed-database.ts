...
const EmployeeSchema = z.object({
  ...
  async function generateSyntheticData(): Promise<Employee[]> {
    ...
    fields: employee_id, first_name, last_name, date_of_birth, address, contact_details, job_details 
    education_details, referrals, skills, hiring_score, emergency_contact. Ensure variety in the 
    data and realistic values.
